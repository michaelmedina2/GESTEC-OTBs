...
INSERT INTO anuncio VALUES (1, 2, 'Reunion Ordinaria Mes Octubre de OTB Naranjal', 'Esta reuniion de por motivo de deudas mmm', '', '2015-09-25', '2015-09-26', 'A');
INSERT INTO anuncio VALUES (2, 3, 'Pagos', 'Pagos por multas', '', '2015-09-26', '2015-09-27', 'A');
...
SELECT pg_catalog.setval('anuncio_pk_anuncio_seq', 2, true);
...
INSERT INTO asignado VALUES (1, 1, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (2, 2, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (3, 3, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (4, 4, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (5, 5, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (6, 6, 1, 1, 'para administrador');
INSERT INTO asignado VALUES (7, 1, 2, 2, NULL);
INSERT INTO asignado VALUES (8, 2, 2, 0, NULL);
INSERT INTO asignado VALUES (9, 3, 2, 0, NULL);
INSERT INTO asignado VALUES (10, 4, 2, 0, NULL);
INSERT INTO asignado VALUES (11, 5, 2, 0, NULL);
INSERT INTO asignado VALUES (12, 6, 2, 0, NULL);
INSERT INTO asignado VALUES (13, 1, 3, 0, NULL);
INSERT INTO asignado VALUES (14, 2, 3, 0, NULL);
INSERT INTO asignado VALUES (15, 3, 3, 0, NULL);
INSERT INTO asignado VALUES (16, 4, 3, 0, NULL);
INSERT INTO asignado VALUES (17, 5, 3, 0, NULL);
INSERT INTO asignado VALUES (18, 6, 3, 0, NULL);
INSERT INTO asignado VALUES (19, 1, 4, 1, NULL);
INSERT INTO asignado VALUES (20, 2, 4, 0, NULL);
INSERT INTO asignado VALUES (21, 3, 4, 0, NULL);
INSERT INTO asignado VALUES (22, 4, 4, 2, NULL);
INSERT INTO asignado VALUES (23, 5, 4, 0, NULL);
INSERT INTO asignado VALUES (24, 6, 4, 0, NULL);
...
SELECT pg_catalog.setval('asignado_pk_asignado_seq', 24, true);
...
INSERT INTO conceptomovimiento VALUES (3, 'Multa desfile', 'A', 'I');
INSERT INTO conceptomovimiento VALUES (1, 'Aportes mensuales', 'A', 'I');
INSERT INTO conceptomovimiento VALUES (2, 'Asistencia al vecino Juan Pérez', 'A', 'I');
...
SELECT pg_catalog.setval('conceptomovimiento_pk_concepto_seq', 3, true);
...
SELECT pg_catalog.setval('gestion_pk_gestion_seq', 1, false);
...
SELECT pg_catalog.setval('manzano_pk_manzano_seq', 1, false);
...
SELECT pg_catalog.setval('movimiento_pk_movimiento_seq', 1, false);
...
INSERT INTO privilegio VALUES (4, 'Anuncio', 'anuncio/', true, true, 'A');
INSERT INTO privilegio VALUES (5, 'Actividad', 'actividad/', false, true, 'A');
INSERT INTO privilegio VALUES (6, 'Usuario', 'usuario/', false, true, 'A');
...
SELECT pg_catalog.setval('privilegio_pk_privilegio_seq', 6, true);
...
SELECT pg_catalog.setval('propiedad_pk_propiedad_seq', 1, false);
...
INSERT INTO rol VALUES (2, 'Vecino', 'A');
INSERT INTO rol VALUES (3, 'Secretaria', 'A');
INSERT INTO rol VALUES (4, 'Tesorero', 'I');
...
INSERT INTO usuario VALUES (1, 1, 1, 'Administrador', 'OTB', 'OTB', '', '', '', '1990-01-01', '', '', '', '', 'A');
INSERT INTO usuario VALUES (2, 1, 1, 'Administrador', 'Homero', 'Freddy', 'Flores', 'Flores', 'M', '1990-05-04', '1234567', '67676767', 'Sacaba', '../../upload/userFoto/avatarM.png', 'A');
INSERT INTO usuario VALUES (3, 1, 4, 'Tesorero', 'diego', 'Diego', 'Gonzales', 'Soto', 'M', '2000-08-12', '123321', '71234567', 'Quillacollo', '../../upload/userFoto/4376avatarM.png', 'A');
...
SELECT pg_catalog.setval('usuario_pk_usuario_seq', 3, true);
