...
ALTER TABLE public.anuncio_pk_anuncio_seq OWNER TO postgres;
...
ALTER TABLE public.asignado OWNER TO postgres;
...
ALTER TABLE public.asignado_pk_asignado_seq OWNER TO postgres;
...
ALTER TABLE public.conceptomovimiento OWNER TO postgres;
...
ALTER TABLE public.conceptomovimiento_pk_concepto_seq OWNER TO postgres;
...
ALTER TABLE public.configuracion_pk_configuracion_seq OWNER TO postgres;
...
ALTER TABLE public.gestion_pk_gestion_seq OWNER TO postgres;
...
ALTER TABLE public.manzano OWNER TO postgres;
...
ALTER TABLE public.manzano_pk_manzano_seq OWNER TO postgres;
...
ALTER TABLE public.movimiento_pk_movimiento_seq OWNER TO postgres;
...
ALTER TABLE public.nominaasistencia OWNER TO postgres;
...
ALTER TABLE public.nominaasistencia_pk_nominasistencia_seq OWNER TO postgres;
...
ALTER TABLE public.otb OWNER TO postgres;
...
ALTER TABLE public.otb_pk_otb_seq OWNER TO postgres;
...
ALTER TABLE public.privilegio_pk_privilegio_seq OWNER TO postgres;
...
ALTER TABLE public.propiedad_pk_propiedad_seq OWNER TO postgres;
...
ALTER TABLE public.rol_pk_rol_seq OWNER TO postgres;
...
ALTER TABLE public.total_pk_total_seq OWNER TO postgres;
...
ALTER TABLE public.usuario_pk_usuario_seq OWNER TO postgres;
...
SELECT pg_catalog.setval('asignado_pk_asignado_seq', 4, true);
...
SELECT pg_catalog.setval('privilegio_pk_privilegio_seq', 4, true);
...
INSERT INTO usuario VALUES (7, 1, 1, 'Administrador', 'Homero', 'Diego', 'Gonzales', 'Soto', 'M', '1989-06-26', '6552810', '79972123', 'CBBA-Quillacollo', '../foto/dgs12092015120545.png', 'A');
