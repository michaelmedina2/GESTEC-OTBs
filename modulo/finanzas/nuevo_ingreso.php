...
<nav class="navbar navbar-inverse">
     <?php      
		...
		$sqlConcepto = $db->executeQuerySQL("SELECT * FROM conceptomovimiento WHERE vch_tipoconcepto='I'");
	...
	<div class="row">
		...
		<div class="col-md-4 col-md-offset-1">
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form accept-charset="UTF-8" name="formIngreso" id="formIngreso" role="form" method="post" action="registrar_ingreso.php">
                      <fieldset>
