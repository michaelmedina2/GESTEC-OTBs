      ...
      <div class="col-md-4 col-md-offset-4">
          <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Registrar Anuncio</h3>
            </div>
              <div class="panel-body">
                <form accept-charset="UTF-8" name="formAnuncio" id="formAnuncio" role="form" method="post" action="nuevo_anuncio.php">
                      <fieldset>
                      <div class="form-group">
                          <input class="form-control" placeholder="Titulo anuncio" name="monto" id="monto" type="text" required>
                      </div>
                      <div class="form-group">
                        <textarea class="form-control" placeholder="Descripcion" name="descrip" id="descrip" required></textarea>
                      </div>
                      <div class="form-group">
                        <input class="form-control" placeholder="Fecha inicio" name="fecha_inicio" id="fecha_inicio" required></textarea>
                      </div>
                      <div class="form-group">
                        <input class="form-control" placeholder="Fecha Fin" name="fecha_fin" id="fecha_fin" required></textarea>
                      </div>
                    <div class="form-group">
